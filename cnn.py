...
img = np.random.randint(4, size=(in_channels, img_H, img_W))

print("img = \n", img)
if padding > 0:
    img = np.pad(array=img, pad_width=((0, 0), (padding, padding),
...
output = np.zeros((out_channels, output_shape_H, output_shape_W))
